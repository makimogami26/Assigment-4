...
export class ResetPasswordComponent implements OnInit {
  ...
  constructor(private activeRoute: ActivatedRoute, private authServices: AuthService, private router: Router) {
  ...
  onSubmit() {
    this.authServices.resetPassword(this.getParamsUserId, this.getParamsSuperKey, this.resetPasswordForm.value).subscribe((response: any) => {
      if (response.success) {
